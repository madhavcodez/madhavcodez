...
- **[shapely/shapely](https://github.com/shapely/shapely)** &mdash; Manipulation and analysis of geometric objects (4.4k+ stars). [#2461](https://github.com/shapely/shapely/pull/2461) raise a clear `ValueError` for non-Polygon geometries in the `MultiPolygon` constructor &middot; [#2459](https://github.com/shapely/shapely/pull/2459) document the `.xy` limitation on polygons and multi-part geometries
- **[rasterio/rasterio](https://github.com/rasterio/rasterio)** &mdash; Geospatial raster I/O for Python (2.5k+ stars). [#3583](https://github.com/rasterio/rasterio/pull/3583) fix the `sieve` size guard for 3-D arrays &middot; [#3578](https://github.com/rasterio/rasterio/pull/3578) accept 3-vertex polygons (triangles) in `is_valid_geom` and `rasterize`
...
- **[pyproj4/pyproj](https://github.com/pyproj4/pyproj)** &mdash; Python interface to PROJ cartographic projections (1.2k+ stars). [#1606](https://github.com/pyproj4/pyproj/pull/1606) add `guess_wkt_version()` to report a WKT string&rsquo;s dialect &middot; [#1604](https://github.com/pyproj4/pyproj/pull/1604) document late-binding behavior of `Transformer` serialization
- **[pysal/esda](https://github.com/pysal/esda)** &mdash; Exploratory spatial data analysis in PySAL (250+ stars). [#513](https://github.com/pysal/esda/pull/513) warn when the Moran family receives a disconnected graph &middot; [#514](https://github.com/pysal/esda/pull/514) robust two-sided pseudo p-value for degenerate null distributions
