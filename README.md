...
- **[shapely/shapely](https://github.com/shapely/shapely)** &mdash; Manipulation and analysis of geometric objects (4.4k+ stars). [#2461](https://github.com/shapely/shapely/pull/2461) raise a clear `ValueError` for non-Polygon geometries in the `MultiPolygon` constructor
